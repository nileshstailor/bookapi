...
@ComponentScans(value = {
		@ComponentScan("com.nt.spring.dao"),
		@ComponentScan("com.nt.spring.service")
})
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		props.put(C3P0_MAX_STATEMENTS, env.getProperty("hibernate.c3po.max_statements"));
		
		factoryBean.setHibernateProperties(props);
		factoryBean.setPackagesToScan("com.nt.spring.model");
